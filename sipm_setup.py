...
from sipm_measurements import sipmMeasurements
from sipm_err import checkPicoAmmeterStatus, checkPicoammeterPS_status
from sipm_basic import SCPI_port
...
def setToAmmeter(port):
	port.write(b'++addr 22\n')
